...
import { CreditCard, CheckCircle, Heart, FileText, Handshake, Banknote, Brain, Coins, Infinity } from 'lucide-react'
  ...
  return (
    <Card className="payment-info-card col-span-full bg-gradient-to-br from-muted/50 via-background to-muted/30 border-2 border-primary/20">
      <CardHeader className="text-center pb-4 sm:pb-6">
        ...
        <p className="text-left text-sm sm:text-base text-muted-foreground">Information om våra betalningsvillkor och process</p>
      </CardHeader>
      
      <CardContent className="space-y-4 sm:space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 sm:gap-6 lg:gap-12 pb-4">

        <div className="space-y-3 h-full flex flex-col justify-between">
            <div className="flex items-center gap-2">
              <FileText className="h-4 w-4 sm:h-5 sm:w-5 text-primary flex-shrink-0" />
              <h3 className="text-base sm:text-lg font-semibold">Avtalsskrivning</h3>
            </div>
            <p className="text-sm text-muted-foreground leading-relaxed">
            För varje uppdrag skriver vi ett avtal som tydligt beskriver omfattning, tidsplan, betalningsmodell och ansvar. Syftet är att skapa en gemensam förståelse och trygghet för båda parter.
            </p>
          ...
          <div className="space-y-3 h-full flex flex-col justify-between">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Vi arbetar med en enkel modell. Halva beloppet faktureras vid projektstart för att täcka planering och utveckling. Resterande belopp faktureras vid lansering när arbetet är färdigt och godkänt.
            </p>
            <div className="flex items-start sm:items-center gap-2 text-sm text-muted-foreground">
              <CheckCircle className="h-4 w-4 text-green-500 flex-shrink-0 mt-0.5 sm:mt-0" />
              <span>Enkel modell för enkel betalning</span>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          ...
          <div className="flex flex-col items-start gap-3">
            <div className="flex w-full items-center justify-between gap-2">
              <h3 className="text-base sm:text-lg font-semibold">
                Abonnemang för helhetslösningar
              </h3>
              <div className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-full bg-primary/10 border border-primary/20 flex-shrink-0">
                <Infinity className="h-5 w-5 sm:h-6 sm:w-6 text-primary" />
              </div>
            </div>
            <div className="space-y-2 min-w-0">
              
              <p className="text-sm text-muted-foreground leading-relaxed">
                Kom igång med din idé utan tung startkostnad. 
                Vi erbjuder ett abonnemang som täcker hela ditt digitala behov – 
                vi tar hand om webbplatser, appar, e-handel och digitala kanaler i ett sammanhållet upplägg som kan anpassas över tid. 
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="pt-4 border-t">
          <h3 className="text-base sm:text-lg font-semibold mb-3 sm:mb-6 flex items-center justify-center gap-2">
            <Handshake className="h-4 w-4 sm:h-5 sm:w-5 text-primary flex-shrink-0" />
            Vår process
          </h3>
          <div className="items-center grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-2 text-center space-y-2">
